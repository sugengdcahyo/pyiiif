...
# Expose
EXPOSE 5050
# CMD ["gunicorn", "-w", "2", "-k", "gthread", "--threads", "2", "-b", "0.0.0.0:5050", "wsgi:app", "--timeout", "120"]
CMD ["gunicorn", "-w", "${GUNICORN_WORKERS:-2}", "-k", "gthread", "--threads", "${GUNICORN_THREADS:-2}", "-b", "0.0.0.0:5050", "wsgi:app", "--timeout", "120"]
